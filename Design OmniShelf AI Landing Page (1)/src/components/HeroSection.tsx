      ...
      <div className="max-w-[1440px] mx-auto grid grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <div className="flex items-center gap-4">
            <Button className="bg-[#3498db] text-white hover:bg-[#2980b9] px-8 h-12 rounded-lg">
              Get Started
            </Button>
            <Button variant="outline" className="border-[#3498db] text-[#3498db] hover:bg-[#3498db]/10 px-8 h-12 rounded-lg">
              Watch Demo
            </Button>
          </div>
